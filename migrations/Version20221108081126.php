 ...
 */
final class Version20221108081126 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE printing_material (printing_id INT NOT NULL, material_id INT NOT NULL, INDEX IDX_CCCFE776E308AC6F (material_id), INDEX IDX_CCCFE7767C9783D2 (printing_id), PRIMARY KEY(printing_id, material_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
