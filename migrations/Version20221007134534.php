 ...
 */
final class Version20221007134534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_printing (id INT AUTO_INCREMENT NOT NULL, printing_id INT NOT NULL, material_id INT NOT NULL, UNIQUE INDEX UNIQ_AE1022987C9783D2 (printing_id), UNIQUE INDEX UNIQ_AE102298E308AC6F (material_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
