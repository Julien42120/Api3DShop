 ...
 */
final class Version20221007140448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_print (id INT AUTO_INCREMENT NOT NULL, printing_id INT NOT NULL, material_id INT NOT NULL, UNIQUE INDEX UNIQ_4A3C116E7C9783D2 (printing_id), UNIQUE INDEX UNIQ_4A3C116EE308AC6F (material_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
